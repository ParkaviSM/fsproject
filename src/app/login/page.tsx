    ...
    <div className="min-h-screen flex">
      <div className="hidden md:flex md:w-5/12 flex-col justify-between p-12" style={{ backgroundColor: 'var(--accent)' }}>
        ...
        <div>
          <p className="font-display text-4xl leading-tight text-white/95 mb-4">
            Clear the list.<br />One thing at a time.
          </p>
          <p className="text-white/70 text-sm max-w-xs">
            A quiet place to keep track of what matters today — nothing more, nothing less.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm mb-8" style={{ color: 'var(--ink-soft)' }}>Log in to see what&apos;s on today.</p>
